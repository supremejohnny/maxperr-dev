  ...
  function figma_rebuild_get_default_news_items() {
    return [
      [
        ...
        'link'  => home_url('/news/installation-tips/'),
      ],
      [
        ...
        'link'  => home_url('/news/public-charging-stations/'),
      ],
      [
        ...
        'link'  => home_url('/news/maxperr-expo-unveil/'),
      ],
      [
        ...
        'link'  => home_url('/news/grid-friendly-charging/'),
      ],
      [
        ...
        'link'  => home_url('/news/smart-om-tco/'),
      ],
      [
        ...
        'link'  => home_url('/news/government-incentives/'),
      ],
    ];
  }
}
